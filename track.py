...
def detect(opt):
    ...
    if save_txt or save_vid:
        s = f"\n{len(list(save_dir.glob('*.txt')))} tracks saved to {save_dir / 'tracks'}" if save_txt else ''
...
if __name__ == '__main__':
    ...
    parser.add_argument('--deep_sort_model', type=str, default='osnet_x0_75_market1501')
    parser.add_argument('--source', type=str, default=r'C:\Users\YIHANG\PycharmProjects\HTAD_dataset\videos\001207.mp4', help='source')  # file/folder, 0 for webcam
